/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.output/server/wrangler.json` (hash: 68a92129edd110696074b74ec211ea30)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_7OGOPeF5EJlRLhBlGIQM-g_DovmtKp2";
	SUPABASE_URL: "https://judvhzedbujbxbuzlxig.supabase.co";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_URL">> {}
}
